...
try {
    ...
    if ($_SERVER["REQUEST_METHOD"] == "POST") {
        ...
        $query = "INSERT INTO gorev (gorev_id, oda_no, hizmetli_tc) VALUES (:gorev_id, :oda_no, :hizmetli_tc)";
        
        
        $statement = $db->prepare($query);

        
        $statement->bindParam(":gorev_id", $gorev_id);
        ...
        header("refresh:3;url=ekle-gorev.php");
    }
...
<head>
    ...
    <title>Görev Ekleme Formu</title>
    <link rel="stylesheet" href="../style.css">
    <link href="https://cdn.jsdelivr.net/npm/bootstrap@5.3.2/dist/css/bootstrap.min.css" rel="stylesheet" integrity="sha384-T3c6CoIi6uLrA9TneNEoa7RxnatzjcDSCmG1MXxSR1GAsXEV/Dwwykc2MPK8M2HN" crossorigin="anonymous">
</head>
<body>
    <h2 class="text-primary text-center bg-dark">Görev Ekleme Formu</h2>
  ...
  <div class="container-fluid">
    ...
    <form method="post" action="<?php echo htmlspecialchars($_SERVER["PHP_SELF"]); ?>">
        <label for="gorev_id">Görev ID</label>
        <input type="text" name="gorev_id" maxlength="6" required>
        <br>
        <label for="oda_no">Oda No</label>
        <input type="text" name="oda_no" maxlength="5" required>
        <br>
        <label for="hizmetli_tc">Hizmetli TC</label>
