...
try {
    ...
    if ($_SERVER["REQUEST_METHOD"] == "POST") {
        ...
        $hemsire_ad = $_POST["hemsire_ad"];
        $hemsire_soyad = $_POST["hemsire_soyad"];
        $hemsire_telefon = $_POST["hemsire_telefon"];
        $hemsire_adres = $_POST["hemsire_adres"];

       
        $query = "INSERT INTO hemsire (hemsire_tc, hemsire_ad, hemsire_soyad, hemsire_telefon, hemsire_adres) VALUES (:hemsire_tc, :hemsire_ad, :hemsire_soyad, :hemsire_telefon, :hemsire_adres)";
        ...
        $statement->bindParam(":hemsire_ad", $hemsire_ad);
        $statement->bindParam(":hemsire_soyad", $hemsire_soyad);
        $statement->bindParam(":hemsire_telefon", $hemsire_telefon);
        $statement->bindParam(":hemsire_adres", $hemsire_adres);
...
<head>
    ...
    <title>Hemşire Ekleme Formu</title>
    <link rel="stylesheet" href="../style.css">
    <link href="https://cdn.jsdelivr.net/npm/bootstrap@5.3.2/dist/css/bootstrap.min.css" rel="stylesheet" integrity="sha384-T3c6CoIi6uLrA9TneNEoa7RxnatzjcDSCmG1MXxSR1GAsXEV/Dwwykc2MPK8M2HN" crossorigin="anonymous">
</head>
<body>
    <h2 class="text-primary text-center bg-dark">Hemşire Ekleme Formu</h2>
  ...
  <div class="container-fluid">
    ...
    <form method="post" action="<?php echo htmlspecialchars($_SERVER["PHP_SELF"]); ?>">
        <label for="hemsire_tc">TC</label>
        <input type="text" name="hemsire_tc" maxlength="11" required>
        <br>
        <label for="hemsire_ad">AD</label>
        <input type="text" name="hemsire_ad" maxlength="35" required>
        <br>
        <label for="hemsire_soyad">Soyad</label>
        <input type="text" name="hemsire_soyad" maxlength="35" required>
        <br>
        <label for="hemsire_telefon">Telefon</label>
        <input type="text" name="hemsire_telefon"maxlength="11" required>
        <br>
        <label for="hemsire_adres">Adres</label>
        <input type="text" name="hemsire_adres" maxlength="150" required>
        <br>
