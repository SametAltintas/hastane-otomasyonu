...
try {
    ...
    if ($_SERVER["REQUEST_METHOD"] == "POST") {
        ...
        $query = "INSERT INTO muayene (muayene_id, tedavi, hasta_id, doktor_tc) VALUES (:muayene_id, :tedavi, :hasta_id, :doktor_tc)";
        
        
        $statement = $db->prepare($query);

        
        $statement->bindParam(":muayene_id", $muayene_id);
        $statement->bindParam(":tedavi", $tedavi);
        ...
        header("refresh:3;url=ekle-muayene.php");
    }
...
<head>
    ...
    <title>Muayene Ekleme Formu</title>
...
<body>
  ...
  <div class="container-fluid">
    ...
    <form method="post" action="<?php echo htmlspecialchars($_SERVER["PHP_SELF"]); ?>">
        <label for="muayene_id">Muayene ID</label>
        <input type="text" name="muayene_id" maxlength="10" required>
        <br>
        <label for="tedavi">Tedavi</label>
        <input type="text" name="tedavi" maxlength="100" required>
        <br>
