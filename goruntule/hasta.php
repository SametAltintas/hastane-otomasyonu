...
<body>
    <h2 class="text-primary text-center bg-dark">Hasta Formu</h2>
...
try {
    ...
    while ($row = $result->fetch(PDO::FETCH_ASSOC)) {
        echo "<tr>
                ...
                <td>{$row['hasta_tc']}</td>
                <td>{$row['hasta_ad']}</td>
                <td>{$row['hasta_soyad']}</td>
                <td>{$row['hasta_tel']}</td>
                <td>{$row['hasta_klinik']}</td>
                <td>{$row['hasta_adres']}</td>
                <td>{$row['randevu_gun']}</td>
                <td>{$row['randevu_saat']}</td>
                <td>{$row['taburcu_tarih']}</td>
                <td>{$row['oda_no']}</td>
