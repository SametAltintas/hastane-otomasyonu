...
<body>
    <h2 class="text-primary text-center bg-dark">Hemsire Formu</h2>
...
try {
    ...
    while ($row = $result->fetch(PDO::FETCH_ASSOC)) {
        echo "<tr>
                <td>{$row['hemsire_tc']}</td>
                <td>{$row['hemsire_ad']}</td>
                <td>{$row['hemsire_soyad']}</td>
                <td>{$row['hemsire_telefon']}</td>
                <td>{$row['hemsire_adres']}</td>
              </tr>";
    }
