...
if(isset($_POST['delete_value'])) {
    ...
    try {
        ...
        $sql = "DELETE FROM recete WHERE recete_id = :delete_value";
        $stmt = $pdo->prepare($sql);
        $stmt->bindParam(':delete_value', $delete_value, PDO::PARAM_INT);
        $stmt->execute();

        echo "Satır başarıyla silindi.";
        header("refresh:3;url=sil-recete.php");
...
<head>
    ...
    <title>Reçete Silme</title>
    <link rel="stylesheet" href="../style.css">
    <link href="https://cdn.jsdelivr.net/npm/bootstrap@5.3.2/dist/css/bootstrap.min.css" rel="stylesheet" integrity="sha384-T3c6CoIi6uLrA9TneNEoa7RxnatzjcDSCmG1MXxSR1GAsXEV/Dwwykc2MPK8M2HN" crossorigin="anonymous">
</head>
<body>
    <h2 class="text-primary text-center bg-dark">Reçete Silme Formu</h2>
...
<form method="post" action="">
    ...
    <input type="text" name="delete_value" maxlenght="5" required>
